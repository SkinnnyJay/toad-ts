...
export const SLASH_COMMAND_MESSAGE = {
  ...
  HELP_SUMMARY:
    "Commands: /help, /add-dir <path>, /agent, /agents, /clear, /compact, /config, /connect, /context, /copy, /cost, /debug, /details, /doctor, /editor, /export <filename>, /hooks, /import <filename>, /init, /login, /logout, /mcp, /memory, /mode, /models <id>, /new <title>, /permissions, /plan <title>, /progress, /rename <title>, /review, /rewind, /security-review, /sessions, /settings, /share, /stats, /status, /themes, /thinking, /undo, /unshare, /redo, /vim",
