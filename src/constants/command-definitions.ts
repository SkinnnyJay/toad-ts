...
export const COMMAND_DEFINITIONS: CommandDefinition[] = [
  ...
  { name: SLASH_COMMAND.COMPACT, description: "Compact session context" },
  ...
  { name: SLASH_COMMAND.MEMORY, description: "Edit AGENTS.md and rules" },
  {
  ...
  { name: SLASH_COMMAND.COPY, description: "Copy last response" },
  { name: SLASH_COMMAND.PLAN, description: "Create a new plan", args: "<title>" },
  { name: SLASH_COMMAND.REWIND, description: "Rewind conversation" },
  ...
  { name: SLASH_COMMAND.UNDO, description: "Undo last change" },
  { name: SLASH_COMMAND.REDO, description: "Redo last change" },
  { name: SLASH_COMMAND.SHARE, description: "Share current session" },
  { name: SLASH_COMMAND.UNSHARE, description: "Unshare current session" },
