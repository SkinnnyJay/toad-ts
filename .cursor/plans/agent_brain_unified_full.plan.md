---
name: agent_brain_unified_full
overview: Full merge of Agent Brain Deep Dive (Part A) and Agent Brain Queues vs Timers (Part B); single doc, both plans included verbatim.
todos:
...
# Part B: Agent Brain Queues vs Timers
