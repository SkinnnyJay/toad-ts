...
- Dont add needless comments make them count.
- Dont always take the eslint ignore route if there is a better way. example: a `any` as a response, you could type the response.
