## 2026-02-14 Execution Update (B235 ancillary-api protected-variant parity)

- Expanded protected ancillary known-API integration coverage for trailing,
  query, and hash variants under auth-before-method semantics.
- Updated:
...
- Expanded ancillary known-API classifier coverage for allowed-method and
  lowercase/whitespace-padded method semantics.
- Updated:
  - `__tests__/unit/server/api-routes.unit.test.ts`
  - `__tests__/unit/server/server-route-classifier.unit.test.ts`
  - `PLAN3.md`
...
## 2026-02-14 Execution Update (B232 ancillary-api method/auth parity)

- Expanded ancillary known-API route coverage to lock method and auth
  semantics across classifier and integration layers.
- Updated:
  - `__tests__/unit/server/api-routes.unit.test.ts`
  - `__tests__/unit/server/server-route-classifier.unit.test.ts`
  - `__tests__/integration/server/headless-server.integration.test.ts`
...
## 2026-02-14 Execution Update (B231 sessions-collection protected parity)
...
## 2026-02-14 Execution Update (B230 protected-api double-trailing auth parity)
...
## 2026-02-14 Execution Update (B225 known-route method normalization parity)
