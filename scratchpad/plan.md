...
- New next candidate:
  - evaluate whether reconnect-order post-close prompt-burst recovery-medallion
    asymmetry should include asymmetric post-close prompt-burst recovery-amulet
