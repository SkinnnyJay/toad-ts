...
describe("headless server", () => {
  ...
  it("returns method not allowed for known API routes with unsupported methods", async () => {
    ...
    try {
      ...
      const doubleTrailingConfigResponse = await fetch(`${baseUrl}/api/config//`, {
        method: "POST",
      });
      expect(doubleTrailingConfigResponse.status).toBe(405);
      await expect(doubleTrailingConfigResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const doubleTrailingConfigResponseWithQuery = await fetch(
        `${baseUrl}/api/config//?scope=all`,
        {
          method: "POST",
        }
      );
      expect(doubleTrailingConfigResponseWithQuery.status).toBe(405);
      await expect(doubleTrailingConfigResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const doubleTrailingConfigResponseWithHash = await fetch(`${baseUrl}/api/config//#summary`, {
        method: "POST",
      });
      expect(doubleTrailingConfigResponseWithHash.status).toBe(405);
      ...
      const doubleTrailingExecuteResponse = await fetch(`${baseUrl}/api/tui/execute-command//`);
      expect(doubleTrailingExecuteResponse.status).toBe(405);
      await expect(doubleTrailingExecuteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const doubleTrailingExecuteResponseWithQuery = await fetch(
        `${baseUrl}/api/tui/execute-command//?scope=all`
      );
      expect(doubleTrailingExecuteResponseWithQuery.status).toBe(405);
      await expect(doubleTrailingExecuteResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const doubleTrailingExecuteResponseWithHash = await fetch(
        `${baseUrl}/api/tui/execute-command//#summary`
      );
      expect(doubleTrailingExecuteResponseWithHash.status).toBe(405);
      await expect(doubleTrailingExecuteResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      ...
      const doubleTrailingSessionRouteResponse = await fetch(
        `${baseUrl}/api/sessions/session-1//`,
        {
          method: "POST",
        }
      );
      expect(doubleTrailingSessionRouteResponse.status).toBe(405);
      await expect(doubleTrailingSessionRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const doubleTrailingSessionRouteResponseWithQuery = await fetch(
        `${baseUrl}/api/sessions/session-1//?scope=all`,
        {
          method: "POST",
        }
      );
      expect(doubleTrailingSessionRouteResponseWithQuery.status).toBe(405);
      await expect(doubleTrailingSessionRouteResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const doubleTrailingSessionRouteResponseWithHash = await fetch(
        `${baseUrl}/api/sessions/session-1//#summary`,
        {
          method: "POST",
        }
      );
      expect(doubleTrailingSessionRouteResponseWithHash.status).toBe(405);
      await expect(doubleTrailingSessionRouteResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      ...
      const doubleTrailingSessionMessagesRouteResponse = await fetch(
        `${baseUrl}/api/sessions/session-1/messages//`,
        {
          method: "POST",
        }
      );
      expect(doubleTrailingSessionMessagesRouteResponse.status).toBe(405);
      await expect(doubleTrailingSessionMessagesRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const doubleTrailingSessionMessagesRouteResponseWithQuery = await fetch(
        `${baseUrl}/api/sessions/session-1/messages//?scope=all`,
        {
          method: "POST",
        }
      );
      expect(doubleTrailingSessionMessagesRouteResponseWithQuery.status).toBe(405);
      await expect(doubleTrailingSessionMessagesRouteResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const doubleTrailingSessionMessagesRouteResponseWithHash = await fetch(
        `${baseUrl}/api/sessions/session-1/messages//#summary`,
        {
          method: "POST",
        }
      );
      expect(doubleTrailingSessionMessagesRouteResponseWithHash.status).toBe(405);
      await expect(doubleTrailingSessionMessagesRouteResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
    } finally {
      await server.close();
  ...
  it("returns method not allowed for known non-api routes with unsupported methods", async () => {
    ...
    try {
      ...
      const doubleTrailingHealthResponse = await fetch(`${baseUrl}/health//`, {
        method: "POST",
      });
      expect(doubleTrailingHealthResponse.status).toBe(405);
      await expect(doubleTrailingHealthResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const doubleTrailingHealthResponseWithQuery = await fetch(`${baseUrl}/health//?probe=1`, {
        method: "POST",
      });
      expect(doubleTrailingHealthResponseWithQuery.status).toBe(405);
      await expect(doubleTrailingHealthResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const doubleTrailingHealthResponseWithHash = await fetch(`${baseUrl}/health//#summary`, {
        method: "POST",
      });
      expect(doubleTrailingHealthResponseWithHash.status).toBe(405);
      await expect(doubleTrailingHealthResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      ...
      const doubleTrailingSessionsResponse = await fetch(`${baseUrl}/sessions//`);
      expect(doubleTrailingSessionsResponse.status).toBe(405);
      await expect(doubleTrailingSessionsResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const doubleTrailingSessionsResponseWithQuery = await fetch(
        `${baseUrl}/sessions//?scope=all`
      );
      expect(doubleTrailingSessionsResponseWithQuery.status).toBe(405);
      await expect(doubleTrailingSessionsResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const doubleTrailingSessionsResponseWithHash = await fetch(`${baseUrl}/sessions//#summary`);
      expect(doubleTrailingSessionsResponseWithHash.status).toBe(405);
      await expect(doubleTrailingSessionsResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      ...
      const doubleTrailingPromptResponse = await fetch(`${baseUrl}/sessions/session-1/prompt//`);
      expect(doubleTrailingPromptResponse.status).toBe(405);
      await expect(doubleTrailingPromptResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const doubleTrailingPromptResponseWithQuery = await fetch(
        `${baseUrl}/sessions/session-1/prompt//?scope=all`
      );
      expect(doubleTrailingPromptResponseWithQuery.status).toBe(405);
      await expect(doubleTrailingPromptResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const doubleTrailingPromptResponseWithHash = await fetch(
        `${baseUrl}/sessions/session-1/prompt//#summary`
      );
      expect(doubleTrailingPromptResponseWithHash.status).toBe(405);
      await expect(doubleTrailingPromptResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      ...
      const doubleTrailingMessagesResponse = await fetch(
        `${baseUrl}/sessions/session-1/messages//`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
      ...
      expect(doubleTrailingMessagesResponse.status).toBe(405);
      await expect(doubleTrailingMessagesResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const doubleTrailingMessagesResponseWithQuery = await fetch(
        `${baseUrl}/sessions/session-1/messages//?scope=all`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
      ...
      expect(doubleTrailingMessagesResponseWithQuery.status).toBe(405);
      await expect(doubleTrailingMessagesResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const doubleTrailingMessagesResponseWithHash = await fetch(
        `${baseUrl}/sessions/session-1/messages//#summary`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
      ...
      expect(doubleTrailingMessagesResponseWithHash.status).toBe(405);
      await expect(doubleTrailingMessagesResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
    } finally {
      await server.close();
  ...
  it("applies auth checks before method-not-allowed semantics on api routes", async () => {
    ...
    try {
      ...
      const unauthenticatedDoubleTrailingResponse = await fetch(`${baseUrl}/api/config//`, {
        method: "POST",
      });
      expect(unauthenticatedDoubleTrailingResponse.status).toBe(401);
      expect(unauthenticatedDoubleTrailingResponse.headers.get("www-authenticate")).toBe("Bearer");
      await expect(unauthenticatedDoubleTrailingResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedDoubleTrailingResponseWithQuery = await fetch(
        `${baseUrl}/api/config//?scope=all`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedDoubleTrailingResponseWithQuery.status).toBe(401);
      expect(unauthenticatedDoubleTrailingResponseWithQuery.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedDoubleTrailingResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedDoubleTrailingResponseWithHash = await fetch(
        `${baseUrl}/api/config//#summary`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedDoubleTrailingResponseWithHash.status).toBe(401);
      expect(unauthenticatedDoubleTrailingResponseWithHash.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      ...
      const unauthenticatedTrailingAgentsRouteResponse = await fetch(`${baseUrl}/api/agents/`, {
        method: "POST",
      });
      expect(unauthenticatedTrailingAgentsRouteResponse.status).toBe(401);
      expect(unauthenticatedTrailingAgentsRouteResponse.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedTrailingAgentsRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedAgentsRouteResponseWithQuery = await fetch(
        `${baseUrl}/api/agents?scope=all`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedAgentsRouteResponseWithQuery.status).toBe(401);
      expect(unauthenticatedAgentsRouteResponseWithQuery.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedAgentsRouteResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedAgentsRouteResponseWithHash = await fetch(
        `${baseUrl}/api/agents#summary`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedAgentsRouteResponseWithHash.status).toBe(401);
      expect(unauthenticatedAgentsRouteResponseWithHash.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedAgentsRouteResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedTrailingEventsRouteResponse = await fetch(`${baseUrl}/api/events/`, {
        method: "POST",
      });
      expect(unauthenticatedTrailingEventsRouteResponse.status).toBe(401);
      expect(unauthenticatedTrailingEventsRouteResponse.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedTrailingEventsRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedEventsRouteResponseWithQuery = await fetch(
        `${baseUrl}/api/events?scope=all`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedEventsRouteResponseWithQuery.status).toBe(401);
      expect(unauthenticatedEventsRouteResponseWithQuery.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedEventsRouteResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedEventsRouteResponseWithHash = await fetch(
        `${baseUrl}/api/events#summary`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedEventsRouteResponseWithHash.status).toBe(401);
      expect(unauthenticatedEventsRouteResponseWithHash.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedEventsRouteResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedTrailingFileSearchRouteResponse = await fetch(
        `${baseUrl}/api/files/search/`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedTrailingFileSearchRouteResponse.status).toBe(401);
      expect(unauthenticatedTrailingFileSearchRouteResponse.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedTrailingFileSearchRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedFileSearchRouteResponseWithQuery = await fetch(
        `${baseUrl}/api/files/search?q=readme`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedFileSearchRouteResponseWithQuery.status).toBe(401);
      expect(unauthenticatedFileSearchRouteResponseWithQuery.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedFileSearchRouteResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedFileSearchRouteResponseWithHash = await fetch(
        `${baseUrl}/api/files/search#summary`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedFileSearchRouteResponseWithHash.status).toBe(401);
      expect(unauthenticatedFileSearchRouteResponseWithHash.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedFileSearchRouteResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedTrailingAppendPromptRouteResponse = await fetch(
        `${baseUrl}/api/tui/append-prompt/`
      );
      expect(unauthenticatedTrailingAppendPromptRouteResponse.status).toBe(401);
      expect(unauthenticatedTrailingAppendPromptRouteResponse.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedTrailingAppendPromptRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedAppendPromptRouteResponseWithQuery = await fetch(
        `${baseUrl}/api/tui/append-prompt?scope=all`
      );
      expect(unauthenticatedAppendPromptRouteResponseWithQuery.status).toBe(401);
      expect(
        unauthenticatedAppendPromptRouteResponseWithQuery.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedAppendPromptRouteResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedAppendPromptRouteResponseWithHash = await fetch(
        `${baseUrl}/api/tui/append-prompt#summary`
      );
      expect(unauthenticatedAppendPromptRouteResponseWithHash.status).toBe(401);
      expect(unauthenticatedAppendPromptRouteResponseWithHash.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedAppendPromptRouteResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedTrailingSubmitPromptRouteResponse = await fetch(
        `${baseUrl}/api/tui/submit-prompt/`
      );
      expect(unauthenticatedTrailingSubmitPromptRouteResponse.status).toBe(401);
      expect(unauthenticatedTrailingSubmitPromptRouteResponse.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedTrailingSubmitPromptRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedSubmitPromptRouteResponseWithQuery = await fetch(
        `${baseUrl}/api/tui/submit-prompt?scope=all`
      );
      expect(unauthenticatedSubmitPromptRouteResponseWithQuery.status).toBe(401);
      expect(
        unauthenticatedSubmitPromptRouteResponseWithQuery.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedSubmitPromptRouteResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedSubmitPromptRouteResponseWithHash = await fetch(
        `${baseUrl}/api/tui/submit-prompt#summary`
      );
      expect(unauthenticatedSubmitPromptRouteResponseWithHash.status).toBe(401);
      expect(unauthenticatedSubmitPromptRouteResponseWithHash.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedSubmitPromptRouteResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedDoubleTrailingExecuteRouteResponse = await fetch(
        `${baseUrl}/api/tui/execute-command//`
      );
      expect(unauthenticatedDoubleTrailingExecuteRouteResponse.status).toBe(401);
      expect(
        unauthenticatedDoubleTrailingExecuteRouteResponse.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedDoubleTrailingExecuteRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedDoubleTrailingExecuteRouteResponseWithQuery = await fetch(
        `${baseUrl}/api/tui/execute-command//?scope=all`
      );
      expect(unauthenticatedDoubleTrailingExecuteRouteResponseWithQuery.status).toBe(401);
      expect(
        unauthenticatedDoubleTrailingExecuteRouteResponseWithQuery.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(
        unauthenticatedDoubleTrailingExecuteRouteResponseWithQuery.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedDoubleTrailingExecuteRouteResponseWithHash = await fetch(
        `${baseUrl}/api/tui/execute-command//#summary`
      );
      expect(unauthenticatedDoubleTrailingExecuteRouteResponseWithHash.status).toBe(401);
      expect(
        unauthenticatedDoubleTrailingExecuteRouteResponseWithHash.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(
        unauthenticatedDoubleTrailingExecuteRouteResponseWithHash.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedDoubleTrailingSessionRouteResponse = await fetch(
        `${baseUrl}/api/sessions/session-1//`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedDoubleTrailingSessionRouteResponse.status).toBe(401);
      expect(
        unauthenticatedDoubleTrailingSessionRouteResponse.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedDoubleTrailingSessionRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedDoubleTrailingSessionRouteResponseWithQuery = await fetch(
        `${baseUrl}/api/sessions/session-1//?scope=all`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedDoubleTrailingSessionRouteResponseWithQuery.status).toBe(401);
      expect(
        unauthenticatedDoubleTrailingSessionRouteResponseWithQuery.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(
        unauthenticatedDoubleTrailingSessionRouteResponseWithQuery.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedDoubleTrailingSessionRouteResponseWithHash = await fetch(
        `${baseUrl}/api/sessions/session-1//#summary`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedDoubleTrailingSessionRouteResponseWithHash.status).toBe(401);
      expect(
        unauthenticatedDoubleTrailingSessionRouteResponseWithHash.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(
        unauthenticatedDoubleTrailingSessionRouteResponseWithHash.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedDoubleTrailingMessagesRouteResponse = await fetch(
        `${baseUrl}/api/sessions/session-1/messages//`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedDoubleTrailingMessagesRouteResponse.status).toBe(401);
      expect(
        unauthenticatedDoubleTrailingMessagesRouteResponse.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedDoubleTrailingMessagesRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedDoubleTrailingMessagesRouteResponseWithQuery = await fetch(
        `${baseUrl}/api/sessions/session-1/messages//?scope=all`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedDoubleTrailingMessagesRouteResponseWithQuery.status).toBe(401);
      expect(
        unauthenticatedDoubleTrailingMessagesRouteResponseWithQuery.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(
        unauthenticatedDoubleTrailingMessagesRouteResponseWithQuery.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedDoubleTrailingMessagesRouteResponseWithHash = await fetch(
        `${baseUrl}/api/sessions/session-1/messages//#summary`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedDoubleTrailingMessagesRouteResponseWithHash.status).toBe(401);
      expect(
        unauthenticatedDoubleTrailingMessagesRouteResponseWithHash.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(
        unauthenticatedDoubleTrailingMessagesRouteResponseWithHash.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const authenticatedDoubleTrailingResponse = await fetch(`${baseUrl}/api/config//`, {
        method: "POST",
        headers: {
          Authorization: "Bearer secret",
        },
      });
      expect(authenticatedDoubleTrailingResponse.status).toBe(405);
      await expect(authenticatedDoubleTrailingResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedDoubleTrailingResponseWithQuery = await fetch(
        `${baseUrl}/api/config//?scope=all`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedDoubleTrailingResponseWithQuery.status).toBe(405);
      await expect(authenticatedDoubleTrailingResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedDoubleTrailingResponseWithHash = await fetch(
        `${baseUrl}/api/config//#summary`,
        {
          method: "POST",
          headers: {
      ...
      const authenticatedTrailingAgentsRouteResponse = await fetch(`${baseUrl}/api/agents/`, {
        method: "POST",
        headers: {
          Authorization: "Bearer secret",
        },
      });
      expect(authenticatedTrailingAgentsRouteResponse.status).toBe(405);
      await expect(authenticatedTrailingAgentsRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedAgentsRouteResponseWithQuery = await fetch(
        `${baseUrl}/api/agents?scope=all`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedAgentsRouteResponseWithQuery.status).toBe(405);
      await expect(authenticatedAgentsRouteResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedAgentsRouteResponseWithHash = await fetch(
        `${baseUrl}/api/agents#summary`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedAgentsRouteResponseWithHash.status).toBe(405);
      await expect(authenticatedAgentsRouteResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      ...
      const authenticatedTrailingEventsRouteResponse = await fetch(`${baseUrl}/api/events/`, {
        method: "POST",
        headers: {
          Authorization: "Bearer secret",
        },
      });
      expect(authenticatedTrailingEventsRouteResponse.status).toBe(405);
      await expect(authenticatedTrailingEventsRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedEventsRouteResponseWithQuery = await fetch(
        `${baseUrl}/api/events?scope=all`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedEventsRouteResponseWithQuery.status).toBe(405);
      await expect(authenticatedEventsRouteResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedEventsRouteResponseWithHash = await fetch(
        `${baseUrl}/api/events#summary`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedEventsRouteResponseWithHash.status).toBe(405);
      await expect(authenticatedEventsRouteResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      ...
      const authenticatedTrailingFileSearchRouteResponse = await fetch(
        `${baseUrl}/api/files/search/`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedTrailingFileSearchRouteResponse.status).toBe(405);
      await expect(authenticatedTrailingFileSearchRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedFileSearchRouteResponseWithQuery = await fetch(
        `${baseUrl}/api/files/search?q=readme`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedFileSearchRouteResponseWithQuery.status).toBe(405);
      await expect(authenticatedFileSearchRouteResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedFileSearchRouteResponseWithHash = await fetch(
        `${baseUrl}/api/files/search#summary`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedFileSearchRouteResponseWithHash.status).toBe(405);
      await expect(authenticatedFileSearchRouteResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      ...
      const authenticatedTrailingAppendPromptRouteResponse = await fetch(
        `${baseUrl}/api/tui/append-prompt/`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedTrailingAppendPromptRouteResponse.status).toBe(405);
      await expect(authenticatedTrailingAppendPromptRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedAppendPromptRouteResponseWithQuery = await fetch(
        `${baseUrl}/api/tui/append-prompt?scope=all`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedAppendPromptRouteResponseWithQuery.status).toBe(405);
      await expect(authenticatedAppendPromptRouteResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedAppendPromptRouteResponseWithHash = await fetch(
        `${baseUrl}/api/tui/append-prompt#summary`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedAppendPromptRouteResponseWithHash.status).toBe(405);
      await expect(authenticatedAppendPromptRouteResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      ...
      const authenticatedTrailingSubmitPromptRouteResponse = await fetch(
        `${baseUrl}/api/tui/submit-prompt/`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedTrailingSubmitPromptRouteResponse.status).toBe(405);
      await expect(authenticatedTrailingSubmitPromptRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedSubmitPromptRouteResponseWithQuery = await fetch(
        `${baseUrl}/api/tui/submit-prompt?scope=all`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedSubmitPromptRouteResponseWithQuery.status).toBe(405);
      await expect(authenticatedSubmitPromptRouteResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedSubmitPromptRouteResponseWithHash = await fetch(
        `${baseUrl}/api/tui/submit-prompt#summary`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedSubmitPromptRouteResponseWithHash.status).toBe(405);
      await expect(authenticatedSubmitPromptRouteResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      ...
      const authenticatedDoubleTrailingExecuteRouteResponse = await fetch(
        `${baseUrl}/api/tui/execute-command//`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedDoubleTrailingExecuteRouteResponse.status).toBe(405);
      await expect(authenticatedDoubleTrailingExecuteRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedDoubleTrailingExecuteRouteResponseWithQuery = await fetch(
        `${baseUrl}/api/tui/execute-command//?scope=all`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedDoubleTrailingExecuteRouteResponseWithQuery.status).toBe(405);
      await expect(
        authenticatedDoubleTrailingExecuteRouteResponseWithQuery.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedDoubleTrailingExecuteRouteResponseWithHash = await fetch(
        `${baseUrl}/api/tui/execute-command//#summary`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedDoubleTrailingExecuteRouteResponseWithHash.status).toBe(405);
      await expect(authenticatedDoubleTrailingExecuteRouteResponseWithHash.json()).resolves.toEqual(
        {
          error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
        }
      );
      ...
      const authenticatedDoubleTrailingSessionRouteResponse = await fetch(
        `${baseUrl}/api/sessions/session-1//`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedDoubleTrailingSessionRouteResponse.status).toBe(405);
      await expect(authenticatedDoubleTrailingSessionRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedDoubleTrailingSessionRouteResponseWithQuery = await fetch(
        `${baseUrl}/api/sessions/session-1//?scope=all`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedDoubleTrailingSessionRouteResponseWithQuery.status).toBe(405);
      await expect(
        authenticatedDoubleTrailingSessionRouteResponseWithQuery.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedDoubleTrailingSessionRouteResponseWithHash = await fetch(
        `${baseUrl}/api/sessions/session-1//#summary`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedDoubleTrailingSessionRouteResponseWithHash.status).toBe(405);
      await expect(authenticatedDoubleTrailingSessionRouteResponseWithHash.json()).resolves.toEqual(
        {
          error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
        }
      );
      ...
      const authenticatedDoubleTrailingMessagesRouteResponse = await fetch(
        `${baseUrl}/api/sessions/session-1/messages//`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedDoubleTrailingMessagesRouteResponse.status).toBe(405);
      await expect(authenticatedDoubleTrailingMessagesRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedDoubleTrailingMessagesRouteResponseWithQuery = await fetch(
        `${baseUrl}/api/sessions/session-1/messages//?scope=all`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedDoubleTrailingMessagesRouteResponseWithQuery.status).toBe(405);
      await expect(
        authenticatedDoubleTrailingMessagesRouteResponseWithQuery.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedDoubleTrailingMessagesRouteResponseWithHash = await fetch(
        `${baseUrl}/api/sessions/session-1/messages//#summary`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedDoubleTrailingMessagesRouteResponseWithHash.status).toBe(405);
      await expect(
        authenticatedDoubleTrailingMessagesRouteResponseWithHash.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
    } finally {
  ...
  it("applies auth checks before method semantics on non-api protected routes", async () => {
    ...
    try {
      ...
      const unauthenticatedDoubleTrailingSessionsResponse = await fetch(`${baseUrl}/sessions//`);
      expect(unauthenticatedDoubleTrailingSessionsResponse.status).toBe(401);
      expect(unauthenticatedDoubleTrailingSessionsResponse.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedDoubleTrailingSessionsResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedDoubleTrailingSessionsResponseWithQuery = await fetch(
        `${baseUrl}/sessions//?scope=all`
      );
      expect(unauthenticatedDoubleTrailingSessionsResponseWithQuery.status).toBe(401);
      expect(
        unauthenticatedDoubleTrailingSessionsResponseWithQuery.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedDoubleTrailingSessionsResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedDoubleTrailingSessionsResponseWithHash = await fetch(
        `${baseUrl}/sessions//#summary`
      );
      expect(unauthenticatedDoubleTrailingSessionsResponseWithHash.status).toBe(401);
      expect(
        unauthenticatedDoubleTrailingSessionsResponseWithHash.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedDoubleTrailingSessionsResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedDoubleTrailingPromptRouteResponse = await fetch(
        `${baseUrl}/sessions/session-1/prompt//`
      );
      expect(unauthenticatedDoubleTrailingPromptRouteResponse.status).toBe(401);
      expect(unauthenticatedDoubleTrailingPromptRouteResponse.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedDoubleTrailingPromptRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedDoubleTrailingPromptRouteResponseWithQuery = await fetch(
        `${baseUrl}/sessions/session-1/prompt//?scope=all`
      );
      expect(unauthenticatedDoubleTrailingPromptRouteResponseWithQuery.status).toBe(401);
      expect(
        unauthenticatedDoubleTrailingPromptRouteResponseWithQuery.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(
        unauthenticatedDoubleTrailingPromptRouteResponseWithQuery.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedDoubleTrailingPromptRouteResponseWithHash = await fetch(
        `${baseUrl}/sessions/session-1/prompt//#summary`
      );
      expect(unauthenticatedDoubleTrailingPromptRouteResponseWithHash.status).toBe(401);
      expect(
        unauthenticatedDoubleTrailingPromptRouteResponseWithHash.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(
        unauthenticatedDoubleTrailingPromptRouteResponseWithHash.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const authenticatedDoubleTrailingSessionsResponse = await fetch(`${baseUrl}/sessions//`, {
        headers: {
          Authorization: "Bearer secret",
        },
      });
      expect(authenticatedDoubleTrailingSessionsResponse.status).toBe(405);
      await expect(authenticatedDoubleTrailingSessionsResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedDoubleTrailingSessionsResponseWithQuery = await fetch(
        `${baseUrl}/sessions//?scope=all`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedDoubleTrailingSessionsResponseWithQuery.status).toBe(405);
      await expect(authenticatedDoubleTrailingSessionsResponseWithQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedDoubleTrailingSessionsResponseWithHash = await fetch(
        `${baseUrl}/sessions//#summary`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedDoubleTrailingSessionsResponseWithHash.status).toBe(405);
      await expect(authenticatedDoubleTrailingSessionsResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      ...
      const authenticatedDoubleTrailingPromptRouteResponse = await fetch(
        `${baseUrl}/sessions/session-1/prompt//`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedDoubleTrailingPromptRouteResponse.status).toBe(405);
      await expect(authenticatedDoubleTrailingPromptRouteResponse.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
      const authenticatedDoubleTrailingPromptRouteResponseWithQuery = await fetch(
        `${baseUrl}/sessions/session-1/prompt//?scope=all`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedDoubleTrailingPromptRouteResponseWithQuery.status).toBe(405);
      await expect(authenticatedDoubleTrailingPromptRouteResponseWithQuery.json()).resolves.toEqual(
        {
          error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
        }
      );
      const authenticatedDoubleTrailingPromptRouteResponseWithHash = await fetch(
        `${baseUrl}/sessions/session-1/prompt//#summary`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedDoubleTrailingPromptRouteResponseWithHash.status).toBe(405);
      await expect(authenticatedDoubleTrailingPromptRouteResponseWithHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.METHOD_NOT_ALLOWED,
      });
  ...
  it("applies auth checks before not-found semantics on unknown routes", async () => {
    ...
    try {
      ...
      const unauthenticatedApiUnknownPost = await fetch(`${baseUrl}/api`, {
        method: "POST",
      });
      expect(unauthenticatedApiUnknownPost.status).toBe(401);
      expect(unauthenticatedApiUnknownPost.headers.get("www-authenticate")).toBe("Bearer");
      await expect(unauthenticatedApiUnknownPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedApiUnknownWithQueryPost = await fetch(`${baseUrl}/api?scope=all`, {
        method: "POST",
      });
      expect(unauthenticatedApiUnknownWithQueryPost.status).toBe(401);
      expect(unauthenticatedApiUnknownWithQueryPost.headers.get("www-authenticate")).toBe("Bearer");
      await expect(unauthenticatedApiUnknownWithQueryPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedApiUnknownWithHashPost = await fetch(`${baseUrl}/api#summary`, {
        method: "POST",
      });
      expect(unauthenticatedApiUnknownWithHashPost.status).toBe(401);
      expect(unauthenticatedApiUnknownWithHashPost.headers.get("www-authenticate")).toBe("Bearer");
      await expect(unauthenticatedApiUnknownWithHashPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedTrailingApiUnknownPost = await fetch(`${baseUrl}/api/`, {
        method: "POST",
      });
      expect(unauthenticatedTrailingApiUnknownPost.status).toBe(401);
      expect(unauthenticatedTrailingApiUnknownPost.headers.get("www-authenticate")).toBe("Bearer");
      await expect(unauthenticatedTrailingApiUnknownPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedTrailingApiUnknownWithQueryPost = await fetch(
        `${baseUrl}/api/?scope=all`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedTrailingApiUnknownWithQueryPost.status).toBe(401);
      expect(unauthenticatedTrailingApiUnknownWithQueryPost.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedTrailingApiUnknownWithQueryPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedTrailingApiUnknownWithHashPost = await fetch(`${baseUrl}/api/#summary`, {
        method: "POST",
      });
      expect(unauthenticatedTrailingApiUnknownWithHashPost.status).toBe(401);
      expect(unauthenticatedTrailingApiUnknownWithHashPost.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedTrailingApiUnknownWithHashPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedDoubleTrailingApiUnknownPost = await fetch(`${baseUrl}/api//`, {
        method: "POST",
      });
      expect(unauthenticatedDoubleTrailingApiUnknownPost.status).toBe(401);
      expect(unauthenticatedDoubleTrailingApiUnknownPost.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedDoubleTrailingApiUnknownPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedDoubleTrailingApiUnknownWithQueryPost = await fetch(
        `${baseUrl}/api//?scope=all`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedDoubleTrailingApiUnknownWithQueryPost.status).toBe(401);
      expect(
        unauthenticatedDoubleTrailingApiUnknownWithQueryPost.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedDoubleTrailingApiUnknownWithQueryPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedDoubleTrailingApiUnknownWithHashPost = await fetch(
        `${baseUrl}/api//#summary`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedDoubleTrailingApiUnknownWithHashPost.status).toBe(401);
      expect(
        unauthenticatedDoubleTrailingApiUnknownWithHashPost.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedDoubleTrailingApiUnknownWithHashPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedSingleSegmentUnknown = await fetch(`${baseUrl}/unknown`);
      expect(unauthenticatedSingleSegmentUnknown.status).toBe(401);
      expect(unauthenticatedSingleSegmentUnknown.headers.get("www-authenticate")).toBe("Bearer");
      await expect(unauthenticatedSingleSegmentUnknown.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedSingleSegmentUnknownPost = await fetch(`${baseUrl}/unknown`, {
        method: "POST",
      });
      expect(unauthenticatedSingleSegmentUnknownPost.status).toBe(401);
      expect(unauthenticatedSingleSegmentUnknownPost.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedSingleSegmentUnknownPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });

      const unauthenticatedSingleSegmentUnknownTrailing = await fetch(`${baseUrl}/unknown/`);
      expect(unauthenticatedSingleSegmentUnknownTrailing.status).toBe(401);
      expect(unauthenticatedSingleSegmentUnknownTrailing.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedSingleSegmentUnknownTrailing.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedSingleSegmentUnknownTrailingPost = await fetch(`${baseUrl}/unknown/`, {
        method: "POST",
      });
      expect(unauthenticatedSingleSegmentUnknownTrailingPost.status).toBe(401);
      expect(unauthenticatedSingleSegmentUnknownTrailingPost.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedSingleSegmentUnknownTrailingPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });

      const unauthenticatedSingleSegmentUnknownDirectQuery = await fetch(
        `${baseUrl}/unknown?scope=all`
      );
      expect(unauthenticatedSingleSegmentUnknownDirectQuery.status).toBe(401);
      expect(unauthenticatedSingleSegmentUnknownDirectQuery.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedSingleSegmentUnknownDirectQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedSingleSegmentUnknownDirectQueryPost = await fetch(
        `${baseUrl}/unknown?scope=all`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedSingleSegmentUnknownDirectQueryPost.status).toBe(401);
      expect(
        unauthenticatedSingleSegmentUnknownDirectQueryPost.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedSingleSegmentUnknownDirectQueryPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });

      const unauthenticatedSingleSegmentUnknownTrailingQuery = await fetch(
        `${baseUrl}/unknown/?scope=all`
      );
      expect(unauthenticatedSingleSegmentUnknownTrailingQuery.status).toBe(401);
      expect(unauthenticatedSingleSegmentUnknownTrailingQuery.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedSingleSegmentUnknownTrailingQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedSingleSegmentUnknownTrailingQueryPost = await fetch(
        `${baseUrl}/unknown/?scope=all`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedSingleSegmentUnknownTrailingQueryPost.status).toBe(401);
      expect(
        unauthenticatedSingleSegmentUnknownTrailingQueryPost.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedSingleSegmentUnknownTrailingQueryPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });

      const unauthenticatedSingleSegmentUnknownDirectHash = await fetch(
        `${baseUrl}/unknown#summary`
      );
      expect(unauthenticatedSingleSegmentUnknownDirectHash.status).toBe(401);
      expect(unauthenticatedSingleSegmentUnknownDirectHash.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedSingleSegmentUnknownDirectHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedSingleSegmentUnknownDirectHashPost = await fetch(
        `${baseUrl}/unknown#summary`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedSingleSegmentUnknownDirectHashPost.status).toBe(401);
      expect(
        unauthenticatedSingleSegmentUnknownDirectHashPost.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedSingleSegmentUnknownDirectHashPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });

      const unauthenticatedSingleSegmentUnknownTrailingHash = await fetch(
        `${baseUrl}/unknown/#summary`
      );
      expect(unauthenticatedSingleSegmentUnknownTrailingHash.status).toBe(401);
      expect(unauthenticatedSingleSegmentUnknownTrailingHash.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedSingleSegmentUnknownTrailingHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedSingleSegmentUnknownTrailingHashPost = await fetch(
        `${baseUrl}/unknown/#summary`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedSingleSegmentUnknownTrailingHashPost.status).toBe(401);
      expect(
        unauthenticatedSingleSegmentUnknownTrailingHashPost.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedSingleSegmentUnknownTrailingHashPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });

      const unauthenticatedSingleSegmentUnknownDoubleTrailing = await fetch(`${baseUrl}/unknown//`);
      expect(unauthenticatedSingleSegmentUnknownDoubleTrailing.status).toBe(401);
      expect(
        unauthenticatedSingleSegmentUnknownDoubleTrailing.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedSingleSegmentUnknownDoubleTrailing.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedSingleSegmentUnknownDoubleTrailingPost = await fetch(
        `${baseUrl}/unknown//`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedSingleSegmentUnknownDoubleTrailingPost.status).toBe(401);
      expect(
        unauthenticatedSingleSegmentUnknownDoubleTrailingPost.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedSingleSegmentUnknownDoubleTrailingPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });

      const unauthenticatedSingleSegmentUnknownDoubleTrailingQuery = await fetch(
        `${baseUrl}/unknown//?scope=all`
      );
      expect(unauthenticatedSingleSegmentUnknownDoubleTrailingQuery.status).toBe(401);
      expect(
        unauthenticatedSingleSegmentUnknownDoubleTrailingQuery.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedSingleSegmentUnknownDoubleTrailingQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedSingleSegmentUnknownDoubleTrailingQueryPost = await fetch(
        `${baseUrl}/unknown//?scope=all`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedSingleSegmentUnknownDoubleTrailingQueryPost.status).toBe(401);
      expect(
        unauthenticatedSingleSegmentUnknownDoubleTrailingQueryPost.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(
        unauthenticatedSingleSegmentUnknownDoubleTrailingQueryPost.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });

      const unauthenticatedSingleSegmentUnknownDoubleTrailingHash = await fetch(
        `${baseUrl}/unknown//#summary`
      );
      expect(unauthenticatedSingleSegmentUnknownDoubleTrailingHash.status).toBe(401);
      expect(
        unauthenticatedSingleSegmentUnknownDoubleTrailingHash.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedSingleSegmentUnknownDoubleTrailingHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      const unauthenticatedSingleSegmentUnknownDoubleTrailingHashPost = await fetch(
        `${baseUrl}/unknown//#summary`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedSingleSegmentUnknownDoubleTrailingHashPost.status).toBe(401);
      expect(
        unauthenticatedSingleSegmentUnknownDoubleTrailingHashPost.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(
        unauthenticatedSingleSegmentUnknownDoubleTrailingHashPost.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedSessionBlankPromptGet = await fetch(`${baseUrl}/sessions//prompt`);
      expect(unauthenticatedSessionBlankPromptGet.status).toBe(401);
      expect(unauthenticatedSessionBlankPromptGet.headers.get("www-authenticate")).toBe("Bearer");
      await expect(unauthenticatedSessionBlankPromptGet.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedTrailingSessionBlankPromptGet = await fetch(
        `${baseUrl}/sessions//prompt/`
      );
      expect(unauthenticatedTrailingSessionBlankPromptGet.status).toBe(401);
      expect(unauthenticatedTrailingSessionBlankPromptGet.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedTrailingSessionBlankPromptGet.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedSessionBlankPromptDirectQueryGet = await fetch(
        `${baseUrl}/sessions//prompt?tail=1`
      );
      expect(unauthenticatedSessionBlankPromptDirectQueryGet.status).toBe(401);
      expect(unauthenticatedSessionBlankPromptDirectQueryGet.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedSessionBlankPromptDirectQueryGet.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedTrailingSessionBlankPromptWithQueryGet = await fetch(
        `${baseUrl}/sessions//prompt/?tail=1`
      );
      expect(unauthenticatedTrailingSessionBlankPromptWithQueryGet.status).toBe(401);
      expect(
        unauthenticatedTrailingSessionBlankPromptWithQueryGet.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedTrailingSessionBlankPromptWithQueryGet.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedSessionBlankMessagesPost = await fetch(`${baseUrl}/sessions//messages`, {
        method: "POST",
      });
      expect(unauthenticatedSessionBlankMessagesPost.status).toBe(401);
      expect(unauthenticatedSessionBlankMessagesPost.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedSessionBlankMessagesPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedSessionBlankMessagesWithQueryPost = await fetch(
        `${baseUrl}/sessions//messages?tail=1`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedSessionBlankMessagesWithQueryPost.status).toBe(401);
      expect(unauthenticatedSessionBlankMessagesWithQueryPost.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedSessionBlankMessagesWithQueryPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedTrailingSessionBlankMessagesPost = await fetch(
        `${baseUrl}/sessions//messages/`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedTrailingSessionBlankMessagesPost.status).toBe(401);
      expect(unauthenticatedTrailingSessionBlankMessagesPost.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedTrailingSessionBlankMessagesPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedTrailingSessionBlankMessagesWithQueryPost = await fetch(
        `${baseUrl}/sessions//messages/?tail=1`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedTrailingSessionBlankMessagesWithQueryPost.status).toBe(401);
      expect(
        unauthenticatedTrailingSessionBlankMessagesWithQueryPost.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(
        unauthenticatedTrailingSessionBlankMessagesWithQueryPost.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedSessionBlankMessagesWithHashPost = await fetch(
        `${baseUrl}/sessions//messages#summary`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedSessionBlankMessagesWithHashPost.status).toBe(401);
      expect(unauthenticatedSessionBlankMessagesWithHashPost.headers.get("www-authenticate")).toBe(
        "Bearer"
      );
      await expect(unauthenticatedSessionBlankMessagesWithHashPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedTrailingSessionBlankMessagesWithHashPost = await fetch(
        `${baseUrl}/sessions//messages/#summary`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedTrailingSessionBlankMessagesWithHashPost.status).toBe(401);
      expect(
        unauthenticatedTrailingSessionBlankMessagesWithHashPost.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedTrailingSessionBlankMessagesWithHashPost.json()).resolves.toEqual(
        {
          error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
        }
      );
      ...
      const unauthenticatedDoubleTrailingSessionBlankMessagesPost = await fetch(
        `${baseUrl}/sessions//messages//`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedDoubleTrailingSessionBlankMessagesPost.status).toBe(401);
      expect(
        unauthenticatedDoubleTrailingSessionBlankMessagesPost.headers.get("www-authenticate")
      ).toBe("Bearer");
      await expect(unauthenticatedDoubleTrailingSessionBlankMessagesPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedDoubleTrailingSessionBlankMessagesWithQueryPost = await fetch(
        `${baseUrl}/sessions//messages//?tail=1`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedDoubleTrailingSessionBlankMessagesWithQueryPost.status).toBe(401);
      expect(
        unauthenticatedDoubleTrailingSessionBlankMessagesWithQueryPost.headers.get(
          "www-authenticate"
        )
      ).toBe("Bearer");
      await expect(
        unauthenticatedDoubleTrailingSessionBlankMessagesWithQueryPost.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const unauthenticatedDoubleTrailingSessionBlankMessagesWithHashPost = await fetch(
        `${baseUrl}/sessions//messages//#summary`,
        {
          method: "POST",
        }
      );
      expect(unauthenticatedDoubleTrailingSessionBlankMessagesWithHashPost.status).toBe(401);
      expect(
        unauthenticatedDoubleTrailingSessionBlankMessagesWithHashPost.headers.get(
          "www-authenticate"
        )
      ).toBe("Bearer");
      await expect(
        unauthenticatedDoubleTrailingSessionBlankMessagesWithHashPost.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.AUTHORIZATION_REQUIRED,
      });
      ...
      const authenticatedApiUnknownPost = await fetch(`${baseUrl}/api`, {
        method: "POST",
        headers: {
          Authorization: "Bearer secret",
        },
      });
      expect(authenticatedApiUnknownPost.status).toBe(404);
      await expect(authenticatedApiUnknownPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });
      ...
      const authenticatedApiUnknownWithQueryPost = await fetch(`${baseUrl}/api?scope=all`, {
        method: "POST",
        headers: {
          Authorization: "Bearer secret",
        },
      });
      expect(authenticatedApiUnknownWithQueryPost.status).toBe(404);
      await expect(authenticatedApiUnknownWithQueryPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });
      ...
      const authenticatedApiUnknownWithHashPost = await fetch(`${baseUrl}/api#summary`, {
        method: "POST",
        headers: {
          Authorization: "Bearer secret",
        },
      });
      expect(authenticatedApiUnknownWithHashPost.status).toBe(404);
      await expect(authenticatedApiUnknownWithHashPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });
      ...
      const authenticatedTrailingApiUnknownPost = await fetch(`${baseUrl}/api/`, {
        method: "POST",
        headers: {
          Authorization: "Bearer secret",
        },
      });
      expect(authenticatedTrailingApiUnknownPost.status).toBe(404);
      await expect(authenticatedTrailingApiUnknownPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });
      ...
      const authenticatedTrailingApiUnknownWithQueryPost = await fetch(
        `${baseUrl}/api/?scope=all`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedTrailingApiUnknownWithQueryPost.status).toBe(404);
      await expect(authenticatedTrailingApiUnknownWithQueryPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });
      ...
      const authenticatedTrailingApiUnknownWithHashPost = await fetch(`${baseUrl}/api/#summary`, {
        method: "POST",
        headers: {
          Authorization: "Bearer secret",
        },
      });
      expect(authenticatedTrailingApiUnknownWithHashPost.status).toBe(404);
      await expect(authenticatedTrailingApiUnknownWithHashPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });
      ...
      const authenticatedDoubleTrailingApiUnknownPost = await fetch(`${baseUrl}/api//`, {
        method: "POST",
        headers: {
          Authorization: "Bearer secret",
        },
      });
      expect(authenticatedDoubleTrailingApiUnknownPost.status).toBe(404);
      await expect(authenticatedDoubleTrailingApiUnknownPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });
      ...
      const authenticatedDoubleTrailingApiUnknownWithQueryPost = await fetch(
        `${baseUrl}/api//?scope=all`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedDoubleTrailingApiUnknownWithQueryPost.status).toBe(404);
      await expect(authenticatedDoubleTrailingApiUnknownWithQueryPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });
      ...
      const authenticatedDoubleTrailingApiUnknownWithHashPost = await fetch(
        `${baseUrl}/api//#summary`,
        {
          method: "POST",
          headers: {
      ...
      const authenticatedSingleSegmentUnknown = await fetch(`${baseUrl}/unknown`, {
        headers: {
          Authorization: "Bearer secret",
        },
      });
      expect(authenticatedSingleSegmentUnknown.status).toBe(404);
      await expect(authenticatedSingleSegmentUnknown.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });
      const authenticatedSingleSegmentUnknownPost = await fetch(`${baseUrl}/unknown`, {
        method: "POST",
        headers: {
          Authorization: "Bearer secret",
        },
      });
      expect(authenticatedSingleSegmentUnknownPost.status).toBe(404);
      await expect(authenticatedSingleSegmentUnknownPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });

      const authenticatedSingleSegmentUnknownTrailing = await fetch(`${baseUrl}/unknown/`, {
        headers: {
          Authorization: "Bearer secret",
        },
      });
      expect(authenticatedSingleSegmentUnknownTrailing.status).toBe(404);
      await expect(authenticatedSingleSegmentUnknownTrailing.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });
      const authenticatedSingleSegmentUnknownTrailingPost = await fetch(`${baseUrl}/unknown/`, {
        method: "POST",
        headers: {
          Authorization: "Bearer secret",
        },
      });
      expect(authenticatedSingleSegmentUnknownTrailingPost.status).toBe(404);
      await expect(authenticatedSingleSegmentUnknownTrailingPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });

      const authenticatedSingleSegmentUnknownDirectQuery = await fetch(
        `${baseUrl}/unknown?scope=all`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedSingleSegmentUnknownDirectQuery.status).toBe(404);
      await expect(authenticatedSingleSegmentUnknownDirectQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });
      const authenticatedSingleSegmentUnknownDirectQueryPost = await fetch(
        `${baseUrl}/unknown?scope=all`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedSingleSegmentUnknownDirectQueryPost.status).toBe(404);
      await expect(authenticatedSingleSegmentUnknownDirectQueryPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });

      const authenticatedSingleSegmentUnknownTrailingQuery = await fetch(
        `${baseUrl}/unknown/?scope=all`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedSingleSegmentUnknownTrailingQuery.status).toBe(404);
      await expect(authenticatedSingleSegmentUnknownTrailingQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });
      const authenticatedSingleSegmentUnknownTrailingQueryPost = await fetch(
        `${baseUrl}/unknown/?scope=all`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedSingleSegmentUnknownTrailingQueryPost.status).toBe(404);
      await expect(authenticatedSingleSegmentUnknownTrailingQueryPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });

      const authenticatedSingleSegmentUnknownDirectHash = await fetch(
        `${baseUrl}/unknown#summary`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedSingleSegmentUnknownDirectHash.status).toBe(404);
      await expect(authenticatedSingleSegmentUnknownDirectHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });
      const authenticatedSingleSegmentUnknownDirectHashPost = await fetch(
        `${baseUrl}/unknown#summary`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedSingleSegmentUnknownDirectHashPost.status).toBe(404);
      await expect(authenticatedSingleSegmentUnknownDirectHashPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });

      const authenticatedSingleSegmentUnknownTrailingHash = await fetch(
        `${baseUrl}/unknown/#summary`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedSingleSegmentUnknownTrailingHash.status).toBe(404);
      await expect(authenticatedSingleSegmentUnknownTrailingHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });
      const authenticatedSingleSegmentUnknownTrailingHashPost = await fetch(
        `${baseUrl}/unknown/#summary`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedSingleSegmentUnknownTrailingHashPost.status).toBe(404);
      await expect(authenticatedSingleSegmentUnknownTrailingHashPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });

      const authenticatedSingleSegmentUnknownDoubleTrailing = await fetch(`${baseUrl}/unknown//`, {
        headers: {
          Authorization: "Bearer secret",
        },
      });
      expect(authenticatedSingleSegmentUnknownDoubleTrailing.status).toBe(404);
      await expect(authenticatedSingleSegmentUnknownDoubleTrailing.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });
      const authenticatedSingleSegmentUnknownDoubleTrailingPost = await fetch(
        `${baseUrl}/unknown//`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedSingleSegmentUnknownDoubleTrailingPost.status).toBe(404);
      await expect(authenticatedSingleSegmentUnknownDoubleTrailingPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });

      const authenticatedSingleSegmentUnknownDoubleTrailingQuery = await fetch(
        `${baseUrl}/unknown//?scope=all`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedSingleSegmentUnknownDoubleTrailingQuery.status).toBe(404);
      await expect(authenticatedSingleSegmentUnknownDoubleTrailingQuery.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });
      const authenticatedSingleSegmentUnknownDoubleTrailingQueryPost = await fetch(
        `${baseUrl}/unknown//?scope=all`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedSingleSegmentUnknownDoubleTrailingQueryPost.status).toBe(404);
      await expect(
        authenticatedSingleSegmentUnknownDoubleTrailingQueryPost.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });

      const authenticatedSingleSegmentUnknownDoubleTrailingHash = await fetch(
        `${baseUrl}/unknown//#summary`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedSingleSegmentUnknownDoubleTrailingHash.status).toBe(404);
      await expect(authenticatedSingleSegmentUnknownDoubleTrailingHash.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
      });
      const authenticatedSingleSegmentUnknownDoubleTrailingHashPost = await fetch(
        `${baseUrl}/unknown//#summary`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedSingleSegmentUnknownDoubleTrailingHashPost.status).toBe(404);
      await expect(authenticatedSingleSegmentUnknownDoubleTrailingHashPost.json()).resolves.toEqual(
        {
          error: SERVER_RESPONSE_MESSAGE.NOT_FOUND,
        }
      );
      ...
      const authenticatedSessionBlankPromptGet = await fetch(`${baseUrl}/sessions//prompt`, {
        headers: {
          Authorization: "Bearer secret",
        },
      });
      expect(authenticatedSessionBlankPromptGet.status).toBe(404);
      await expect(authenticatedSessionBlankPromptGet.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.UNKNOWN_ENDPOINT,
      });
      ...
      const authenticatedTrailingSessionBlankPromptGet = await fetch(
        `${baseUrl}/sessions//prompt/`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedTrailingSessionBlankPromptGet.status).toBe(404);
      await expect(authenticatedTrailingSessionBlankPromptGet.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.UNKNOWN_ENDPOINT,
      });
      ...
      const authenticatedSessionBlankPromptDirectQueryGet = await fetch(
        `${baseUrl}/sessions//prompt?tail=1`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedSessionBlankPromptDirectQueryGet.status).toBe(404);
      await expect(authenticatedSessionBlankPromptDirectQueryGet.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.UNKNOWN_ENDPOINT,
      });
      ...
      const authenticatedTrailingSessionBlankPromptWithQueryGet = await fetch(
        `${baseUrl}/sessions//prompt/?tail=1`,
        {
          headers: {
            Authorization: "Bearer secret",
      ...
      expect(authenticatedTrailingSessionBlankPromptWithQueryGet.status).toBe(404);
      await expect(authenticatedTrailingSessionBlankPromptWithQueryGet.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.UNKNOWN_ENDPOINT,
      });
      ...
      const authenticatedSessionBlankMessagesPost = await fetch(`${baseUrl}/sessions//messages`, {
        method: "POST",
        headers: {
          Authorization: "Bearer secret",
        },
      });
      expect(authenticatedSessionBlankMessagesPost.status).toBe(404);
      await expect(authenticatedSessionBlankMessagesPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.UNKNOWN_ENDPOINT,
      });
      ...
      const authenticatedSessionBlankMessagesWithQueryPost = await fetch(
        `${baseUrl}/sessions//messages?tail=1`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedSessionBlankMessagesWithQueryPost.status).toBe(404);
      await expect(authenticatedSessionBlankMessagesWithQueryPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.UNKNOWN_ENDPOINT,
      });
      ...
      const authenticatedTrailingSessionBlankMessagesPost = await fetch(
        `${baseUrl}/sessions//messages/`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedTrailingSessionBlankMessagesPost.status).toBe(404);
      await expect(authenticatedTrailingSessionBlankMessagesPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.UNKNOWN_ENDPOINT,
      });
      ...
      const authenticatedTrailingSessionBlankMessagesWithQueryPost = await fetch(
        `${baseUrl}/sessions//messages/?tail=1`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedTrailingSessionBlankMessagesWithQueryPost.status).toBe(404);
      await expect(authenticatedTrailingSessionBlankMessagesWithQueryPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.UNKNOWN_ENDPOINT,
      });
      ...
      const authenticatedSessionBlankMessagesWithHashPost = await fetch(
        `${baseUrl}/sessions//messages#summary`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedSessionBlankMessagesWithHashPost.status).toBe(404);
      await expect(authenticatedSessionBlankMessagesWithHashPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.UNKNOWN_ENDPOINT,
      });
      ...
      const authenticatedTrailingSessionBlankMessagesWithHashPost = await fetch(
        `${baseUrl}/sessions//messages/#summary`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedTrailingSessionBlankMessagesWithHashPost.status).toBe(404);
      await expect(authenticatedTrailingSessionBlankMessagesWithHashPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.UNKNOWN_ENDPOINT,
      });
      ...
      const authenticatedDoubleTrailingSessionBlankMessagesPost = await fetch(
        `${baseUrl}/sessions//messages//`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedDoubleTrailingSessionBlankMessagesPost.status).toBe(404);
      await expect(authenticatedDoubleTrailingSessionBlankMessagesPost.json()).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.UNKNOWN_ENDPOINT,
      });
      ...
      const authenticatedDoubleTrailingSessionBlankMessagesWithQueryPost = await fetch(
        `${baseUrl}/sessions//messages//?tail=1`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedDoubleTrailingSessionBlankMessagesWithQueryPost.status).toBe(404);
      await expect(
        authenticatedDoubleTrailingSessionBlankMessagesWithQueryPost.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.UNKNOWN_ENDPOINT,
      });
      ...
      const authenticatedDoubleTrailingSessionBlankMessagesWithHashPost = await fetch(
        `${baseUrl}/sessions//messages//#summary`,
        {
          method: "POST",
          headers: {
      ...
      expect(authenticatedDoubleTrailingSessionBlankMessagesWithHashPost.status).toBe(404);
      await expect(
        authenticatedDoubleTrailingSessionBlankMessagesWithHashPost.json()
      ).resolves.toEqual({
        error: SERVER_RESPONSE_MESSAGE.UNKNOWN_ENDPOINT,
      });
    } finally {
