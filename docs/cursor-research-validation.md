...
| Hook IPC latency feasibility | End-to-end Node hook shim -> IPC server roundtrip with threshold assertion | `__tests__/integration/core/cursor-channels.integration.test.ts` (`HOOK_ROUNDTRIP_MAX_MS = 500`) |
